...
const ApplicationManagementPage: React.FC = () => {
  ...
  const [quickCreateData, setQuickCreateData] = useState({
    ...
    period: '',
    template_id: '',
    purpose: 'supply_management' as 'supply_management' | 'demand_calculation' | 'capacity_forecast'
  });
  ...
  const handleQuickCreate = async () => {
    try {
      // 加载可用模板
      const availableTemplates = await applicationTemplateService.getActiveTemplates();
              ...
              <div className="flex items-start space-x-4">
                ...
                <div className="w-full">
                  ...
                  <div className="grid grid-cols-1 md:grid-cols-2 gap-4 text-sm text-gray-600">
                    <div>
                      <h4 className="font-medium text-gray-700 mb-1">📋 申请表模板管理</h4>
                    ...
                    <div>
                      <h4 className="font-medium text-gray-700 mb-1">📊 申请表实例管理</h4>
                      <ul className="space-y-1 pl-4">
                    ...
                    <div>
                      <h4 className="font-medium text-gray-700 mb-1">🔧 管控表功能</h4>
                      <ul className="space-y-1 pl-4">
                        <li>• 完整的耗材信息管理</li>
                    ...
                    <div>
                      <h4 className="font-medium text-gray-700 mb-1">🧮 计算表功能</h4>
                      <ul className="space-y-1 pl-4">
                        <li>• 自动计算月度需求量</li>
                        <li>• 支持产能预测和需求分析</li>
                        <li>• 与管控表数据智能关联</li>
          ...
          <ModalBody>
            <div className="space-y-4">
              <div className="bg-blue-50 p-4 rounded-lg">
                <h4 className="font-medium text-blue-800 mb-2">💡 快速创建优势</h4>
              ...
              <div className="grid grid-cols-1 gap-4">
                <Input
                  ...
                  onChange={(e) => setQuickCreateData({...quickCreateData, department: e.target.value})}
                  isRequired
                />
                ...
                <Input
                  ...
                  onChange={(e) => setQuickCreateData({...quickCreateData, period: e.target.value})}
                  isRequired
                />
                ...
                <Select
                  ...
                  onSelectionChange={(keys) => {
                    ...
                    setQuickCreateData({...quickCreateData, purpose: purpose as any});
                  }}
                  isRequired
                >
                  <SelectItem key="supply_management">耗材管控申请表</SelectItem>
                ...
                {quickCreateData.purpose && (
                  <div className="bg-green-50 p-3 rounded-lg">
                    <div className="flex items-center gap-2 mb-2">
                      <span className="text-green-600 text-sm font-medium">推荐模板</span>
                      <Chip size="sm" color="success" variant="flat">
                        {getTemplatesByPurpose(quickCreateData.purpose).length} 个可用
                      </Chip>
                    </div>
                ...
                <Select
                  ...
                  selectedKeys={quickCreateData.template_id ? [quickCreateData.template_id] : []}
                  onSelectionChange={(keys) => {
                    const templateId = Array.from(keys)[0] as string;
                    setQuickCreateData({...quickCreateData, template_id: templateId});
                  }}
                >
                  {getTemplatesByPurpose(quickCreateData.purpose).map(template => (
                    <SelectItem key={template.id.toString()} textValue={template.name}>
              ...
              <div className="bg-yellow-50 p-3 rounded-lg">
                <div className="text-sm text-yellow-800">
                  ...
                  {quickCreateData.department && quickCreateData.period && (
                    <span className="ml-2">
                      将创建名为 "{quickCreateData.department}_{quickCreateData.period}_{getPurposeLabel(quickCreateData.purpose)}申请表" 的申请表
                    </span>
                  )}
                </div>
              </div>
