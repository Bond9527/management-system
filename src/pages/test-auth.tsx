    ...
    <div className="container mx-auto p-6 space-y-6">
      ...
      <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
        ...
        <Card>
          ...
          <CardBody>
            <div className="space-y-2">
              <Button size="sm" onClick={analyzeToken}>Refresh Token Info</Button>
          ...
          <CardBody>
            <div className="space-y-2">
              <div className="flex gap-2">
                <Button size="sm" color="primary" onClick={testUserInfo} disabled={loading}>
                  Test Get User Info
                </Button>
                <Button size="sm" color="secondary" onClick={testLogin} disabled={loading}>
                  Test Login
                </Button>
        ...
        <Card className="md:col-span-2">
          ...
          <CardBody>
            <div className="space-y-2">
              <p><strong>Is Authenticated (isAuthenticated()):</strong> {isAuthenticated().toString()}</p>
              <p><strong>Auth Context User:</strong></p>
              <pre className="text-xs bg-gray-100 p-2 rounded overflow-auto max-h-40">
                {JSON.stringify(user, null, 2)}
              </pre>
              <Button size="sm" onClick={refreshUser}>Refresh User</Button>
            </div>
          </CardBody>
        </Card>
      </div>
